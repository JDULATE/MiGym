...
export default {
  ...
  'Unpair': '取消组合',
  'Fitness profile': '健身档案',
  'Set up your fitness profile': '设置你的健身档案',
  'Goal, experience, equipment — what later features build on.': '目标、经验、器械——后续功能的基础。',
  'Training goal': '训练目标',
  'Not set': '未设置',
  'Hypertrophy': '增肌',
  'Weight loss': '减脂',
  ...
  '{0} min': '{0} 分钟',
  'Session length': '训练时长',
  'Available equipment': '可用器械',
  'Used to match exercises to what you can train with.': '用于把动作匹配到你实际拥有的器械。',
  '{0} selected': '已选{0}项',
  'Name & photo': '姓名与照片',
  'Change photo': '更换照片',
  'Remove photo': '移除照片',
  ...
  'Preferences': '偏好',
  'Anything worth remembering — schedule, likes and dislikes. Free text for now; future features may read it.': '任何值得记住的事——时间安排、好恶。目前仅为自由文本；未来功能可能会读取。',
  'Body': '身体',
  'Height': '身高',
  'Measurements': '测量记录',
  'Neck, waist, arms — logged over time, never overwritten.': '颈、腰、臂——随时间记录，绝不覆盖。',
  '{0} readings': '{0} 次记录',
  'Centimetres. A new reading is added to the log — nothing already recorded is overwritten.': '厘米。新读数会追加到记录中——已有内容不会被覆盖。',
  'Neck': '颈围',
  'Waist': '腰围',
  'Hips': '臀围',
  'Upper arm': '上臂',
  ...
  'Progress overview': '进步总览',
  'Volume · 7 days': '训练量 · 7天',
  'Ø volume · 8 wks': '平均训练量 · 8周',
  'Ø session': '平均训练',
  'PRs · 30 d': '个人纪录 · 30天',
  'Improving': '在进步',
  'Stalled': '停滞中',
  '{0} est. 1RM': '{0} 估算1RM',
  'last trained {0} days ago': '上次训练是{0}天前',
  'no change': '没有变化',
  ...
  'Alternatives': '替代动作',
  'Difficulty': '难度',
  'Load a starter plan': '加载入门计划',
  'Push / Pull / Legs': '推 / 拉 / 腿',
  'Upper / Lower': '上 / 下',
  'Full Body': '全身',
  'Starter plan loaded': '入门计划已加载',
  'Session': '训练',
  'Target RIR': '目标 RIR',
  'To failure': '力竭',
  'Default ({0}s)': '默认（{0}秒）',
  'RIR ≤ {0}': 'RIR ≤ {0}',
  'A starting point, not a program — every routine stays fully editable. Your current routines are kept.': '起点而非固定课程——每个计划仍可编辑。现有计划会保留。',
  'Push / Pull / Legs, Upper / Lower or Full Body': '推 / 拉 / 腿、上 / 下或全身',
  'Adjustments': '调整建议',
  'Raise {0} to {1} {2}.': '将{0}提高到{1} {2}。',
  'Every rep hit in your last two sessions.': '最近两次训练每次都完成全部次数。',
  'Every rep hit in your last two sessions, within the target RIR of {0}.': '最近两次训练全部完成，且在目标RIR {0}以内。',
  'Ease {0} back to {1} {2} for a session.': '将{0}降回{1} {2}练一次。',
  'Reps landed short at RIR {0} — your target is {1}. Build back from {2} {3}.': 'RIR {0} 时次数未达标——目标是{1}。从{2} {3}重建。',
  '{0}: consider a deload week or a variation.': '{0}：考虑减载一周或换一个变式。',
  'No estimated-1RM change in {0} days.': '{0}天没有估算1RM变化。',
  'You planned {0} sessions a week — the last four weeks averaged {1}.': '你计划每周{0}次训练——过去四周平均只有{1}。',
  'Consistency drives progress more than any single session.': '坚持比任何单次训练都更能带来进步。',
  'AI coach': 'AI 教练',
  'Ask the coach': '询问教练',
  'Answers come from the endpoint you configure below, built only from your logged data. Nothing is sent anywhere until you ask a question.': '回答来自你在下方配置的端点，仅基于你记录的数据。在你提问之前不会发送任何内容。',
  'Ready — questions live in Stats → Progress overview.': '已就绪——提问入口在“统计 → 进步总览”。',
  'Off. Configure an OpenAI-compatible endpoint to enable it.': '关闭中。配置兼容 OpenAI 的端点即可启用。',
  'Coach disabled': '教练已关闭',
  'Pick a model below first': '请先在下方选择模型',
  'OpenAI-compatible endpoint — Ollama, LM Studio, OpenAI, Groq…': '兼容 OpenAI 的端点——Ollama、LM Studio、OpenAI、Groq……',
  'Model': '模型',
  'API key (if needed)': 'API 密钥（如需要）',
  'Stored only on this device — never synced, never in backups.': '仅存储在此设备上——从不同步，也不会进入备份。',
  'Answers are built only from your logged data — double-check anything important.': '回答仅基于你记录的数据——重要信息请自行核实。',
  'Ask about your training…': '问一个关于训练的问题……',
  'Thinking': '思考中…',
  'Ask': '提问',
  'Thinking…': '思考中…',
  'Ask the coach about your training': '向教练询问你的训练情况',
  'Sync & backup': '同步与备份',
  'Your base lives on this device; the linked profile keeps a synced copy.': '你的基础数据保存在此设备上；关联的账号会保留一份同步副本。',
  'Everything already works without an account. Link one only to keep a synced copy for new devices.': '没有账号一切照常。仅当你想在新设备上保留副本时才关联。',
  'Linked with passkey — every change syncs to this profile.': '已通过通行密钥关联——每次更改都会同步。',
  'Unlink from server': '从服务器解除关联',
  'Unlink from server?': '从服务器解除关联？',
  'A final backup is pushed first. Your plan, workouts and history stay on this device.': '先推送最后一次备份。计划、训练和历史都留在此设备上。',
  'Unlink': '解除关联',
  'Device unlinked — your data stayed here': '已解除关联——数据仍在此设备上',
  'End all sessions': '结束所有会话',
  'Signs this profile out on all your other devices too.': '同时在你其他设备上登出该档案。',
  'Create a server backup profile': '创建服务器备份档案',
  'Keeps a synced copy for new devices — with passkeys, no passwords.': '为新设备保留同步副本——使用通行密钥，无需密码。',
  'Link to an existing profile': '关联到已有档案',
  'Local-first: nothing leaves this device unless you link a server above.': '本地优先：除非你在上方关联服务器，否则任何数据都不会离开此设备。',
  'Restore from snapshot': '从快照恢复',
  'Server-side copies taken before each sync. Restoring merges them into this device — nothing on it is deleted.': '每次同步前保存的副本。恢复会与设备合并——不会删除任何内容。',
  'No snapshots yet — they appear after the first sync.': '还没有快照——首次同步后会出现。',
  'Restore this snapshot?': '恢复此快照？',
  'It will be merged with what this device already has.': '它将与设备已有的数据合并。',
  'Restore': '恢复',
  'No data in that snapshot.': '该快照中没有数据。',
  'Snapshot restored and merged': '快照已恢复并合并',
  'Restore failed': '恢复失败',
  'Loading…': '加载中……',
  'Coach': '教练',
  'Clients': '客户',
  'Share your training with a coach': '与教练分享你的训练',
  'Choose what a coach may see:': '选择教练可以看到的内容：',
  'Summary only': '仅摘要',
  'Full workouts': '完整训练',
  'Generate pairing code': '生成配对码',
  'Give this code to your coach — it expires in 15 minutes.': '把这个码给你的教练——15分钟后失效。',
  'Your coaches': '你的教练',
  'No coach linked.': '尚未关联教练。',
  'Revoke access?': '撤销访问权限？',
  'The coach immediately loses access to your data. Nothing is deleted on your side.': '教练会立即失去对你数据的访问权限。你这边不会删除任何内容。',
  'Revoke access': '撤销访问',
  'Access revoked': '已撤销访问权限',
  'No clients yet — redeem a pairing code from a client.': '还没有客户——输入客户的配对码即可关联。',
  '30-day sessions': '30天训练次数',
  'Add a note (visible to the client)': '添加备注（客户可见）',
  'Note saved': '备注已保存',
  'You see what each client consented to — nothing more.': '你只能看到每个客户同意共享的内容——仅此而已。',
  'Last session: {0}': '上次训练：{0}',
  'Coach notes': '教练备注',
  'Revoke': '撤销',
  ...
  'Continue': '继续',
  'Back': '返回',
  'Welcome to MiGym': '欢迎来到 MiGym',
  'Hi! I’m Giwi — I’ll help you set MiGym up for you.': '嗨！我是 Giwi——我来帮你设置 MiGym。',
  'First, what’s your name?': '首先，你叫什么名字？',
  'Nice to meet you, {0}!': '很高兴认识你，{0}！',
  'How old are you?': '你多大了？',
  'Age': '年龄',
  'What do you weigh right now?': '你现在体重是多少？',
  'Current weight': '当前体重',
  'What’s your height?': '你的身高是多少？',
  'What’s your main goal?': '你的主要目标是什么？',
  'Your profile': '你的资料',
  'Perfect! I know a little about you now.': '完美！我已经对你有了一点了解。',
  'Now I’ll show you how MiGym works.': '现在我来教你 MiGym 怎么用。',
  'Your home': '你的主页',
  'Start a workout': '开始训练',
  'The current exercise': '当前动作',
  'Log every set': '记录每组训练',
  'Progress': '进步',
  'Redo the walkthrough': '重新播放引导教程',
  'Replays the Giwi tour — your data is untouched.': '重播 Giwi 引导——不会改动你的数据。',
  'Help': '帮助',
  'Today’s workout and a quick look at your progress live here.': '这里显示今天的训练和进度概览。',
  'Organise your training days and pick the exercises for each one.': '安排训练日并为每天选择动作。',
  'When you’re ready, this button starts today’s session.': '准备好后，点这个按钮开始今天的训练。',
  'During a session you’ll see the exercise here, with your previous performance right under it.': '训练时这里会显示当前动作，正下方是你的上次表现。',
  ...
  'for': '为',
  'Terms & privacy': '条款与隐私',
  'MiGym stores everything on your device. Nothing is sent to external servers unless you explicitly link a server profile for sync.': 'MiGym 将所有内容存储在您的设备上。除非您明确链接服务器配置文件进行同步，否则不会向外部服务器发送任何内容。',
  'Cookies & tracking': 'Cookie 与跟踪',
  'MiGym does not use tracking cookies or analytics. The only data stored is your training log, settings and preferences — all on your device.': 'MiGym 不使用跟踪 Cookie 或分析。唯一存储的数据是您的训练日志、设置和偏好——全部在您的设备上。',
  'No account required': '无需账户',
  'The app works fully offline without an account. Linking a server profile is optional and only enables sync across devices.': '应用完全离线运行，无需账户。链接服务器配置文件仅用于跨设备同步。',
  'Open source': '开源',
  'MiGym is open source under AGPL-3.0. You can inspect, modify and self-host it freely.': 'MiGym 是基于 AGPL-3.0 的开源软件。您可以自由检查、修改和自托管。',
  'No medical advice': '非医疗建议',
  'MiGym is a training log, not a medical device. Consult a professional before starting any exercise program.': 'MiGym 是训练日志，不是医疗设备。在开始任何锻炼计划前请咨询专业人士。',
  'Contact': '联系方式',
