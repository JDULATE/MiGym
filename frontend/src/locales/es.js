...
export default {
  ...
  'Goal, experience, equipment — what later features build on.': 'Objetivo, experiencia, equipo — en lo que se apoyarán las funciones futuras.',
  ...
  'Anything worth remembering — schedule, likes and dislikes. Free text for now; future features may read it.': 'Todo lo que valga la pena recordar — horarios, gustos y disgustos. Por ahora es texto libre; funciones futuras podrían leerlo.',
  'Body': 'Cuerpo',
  'Height': 'Altura',
  'Measurements': 'Medidas',
  'Neck, waist, arms — logged over time, never overwritten.': 'Cuello, cintura, brazos — registrados con el tiempo, nunca sobrescritos.',
  '{0} readings': '{0} mediciones',
  'Centimetres. A new reading is added to the log — nothing already recorded is overwritten.': 'Centímetros. Una nueva medición se añade al registro — nada de lo ya registrado se sobrescribe.',
  'Neck': 'Cuello',
  'Waist': 'Cintura',
  'Hips': 'Caderas',
  'Upper arm': 'Brazo',
  ...
  'Volume · 7 days': 'Volumen · 7 días',
  'Ø volume · 8 wks': 'Ø volumen · 8 sem.',
  'Ø session': 'Ø sesión',
  'PRs · 30 d': 'Récords · 30 d',
  'Improving': 'Mejorando',
  'Stalled': 'Estancado',
  '{0} est. 1RM': '{0} 1RM est.',
  ...
  'RIR ≤ {0}': 'RIR ≤ {0}',
  'A starting point, not a program — every routine stays fully editable. Your current routines are kept.': 'Un punto de partida, no un programa: cada rutina sigue siendo editable. Tus rutinas actuales se conservan.',
  ...
  'Reps landed short at RIR {0} — your target is {1}. Build back from {2} {3}.': 'Las repeticiones se quedaron cortas a RIR {0}: tu objetivo es {1}. Recupera desde {2} {3}.',
  ...
  'You planned {0} sessions a week — the last four weeks averaged {1}.': 'Planificabas {0} sesiones por semana: las últimas cuatro semanas promediaron {1}.',
  ...
  'Ready — questions live in Stats → Progress overview.': 'Listo: las preguntas están en Estadísticas → Resumen de progreso.',
  ...
  'OpenAI-compatible endpoint — Ollama, LM Studio, OpenAI, Groq…': 'Endpoint compatible con OpenAI: Ollama, LM Studio, OpenAI, Groq…',
  'Model': 'Modelo',
  'API key (if needed)': 'Clave de API (si es necesaria)',
  'Stored only on this device — never synced, never in backups.': 'Guardada solo en este dispositivo: nunca se sincroniza ni aparece en copias.',
  'Answers are built only from your logged data — double-check anything important.': 'Las respuestas se basan solo en tus datos registrados: verifica lo importante.',
  'Ask about your training…': 'Pregunta sobre tu entrenamiento…',
  'Thinking': 'Pensando…',
  'Ask': 'Preguntar',
  'Thinking…': 'Pensando…',
  ...
  'Linked with passkey — every change syncs to this profile.': 'Vinculado con passkey: cada cambio se sincroniza.',
  ...
  'Unlink': 'Desvincular',
  'Device unlinked — your data stayed here': 'Dispositivo desvinculado: tus datos se quedaron aquí',
  ...
  'Keeps a synced copy for new devices — with passkeys, no passwords.': 'Guarda una copia sincronizada para nuevos dispositivos: con passkeys, sin contraseñas.',
  ...
  'Server-side copies taken before each sync. Restoring merges them into this device — nothing on it is deleted.': 'Copias guardadas antes de cada sincronización. Restaurarlas las combina con este dispositivo: no se borra nada.',
  'No snapshots yet — they appear after the first sync.': 'Aún no hay instantáneas: aparecen tras la primera sincronización.',
  ...
  'Give this code to your coach — it expires in 15 minutes.': 'Dale este código a tu entrenador: caduca en 15 minutos.',
  ...
  'No clients yet — redeem a pairing code from a client.': 'Aún no hay clientes: canjea un código de emparejamiento de un cliente.',
  ...
  'You see what each client consented to — nothing more.': 'Ves solo lo que cada cliente ha consentido: nada más.',
  'Last session: {0}': 'Última sesión: {0}',
  ...
  'Hi! I’m Giwi — I’ll help you set MiGym up for you.': '¡Hola! Soy Giwi y te ayudaré a configurar MiGym.',
  ...
  'Now I’ll show you how MiGym works.': 'Ahora te enseñaré cómo funciona MiGym.',
  'Your home': 'Tu inicio',
  ...
  'Replays the Giwi tour — your data is untouched.': 'Repite el recorrido de Giwi: tus datos no se tocan.',
  'Help': 'Ayuda',
  'Today’s workout and a quick look at your progress live here.': 'Aquí están el entrenamiento de hoy y un vistazo a tu progreso.',
  ...
  'During a session you’ll see the exercise here, with your previous performance right under it.': 'Durante una sesión verás aquí el ejercicio, con tu rendimiento anterior justo debajo.',
  ...
  'MiGym does not use tracking cookies or analytics. The only data stored is your training log, settings and preferences — all on your device.': 'MiGym no utiliza cookies de rastreo ni análisis. Los únicos datos almacenados son tu registro de entrenamiento, configuración y preferencias, todo en tu dispositivo.',
