...
export default function Home() {
  ...
  return <div className="narrow">
    <div className="hdr">
      <div><h1>{user ? t('Hi {0}', user.name) : 'MiGym'}</h1><div className="sub">{today.toLocaleDateString(dateLocale(), { weekday: 'long', day: 'numeric', month: 'long' })}</div></div>
    ...
    <div className="card">
      ...
      <div className="today-row" data-giwi="home-today" onClick={onToday}>
    ...
    <div className="card">
      ...
      {bw ? <>
        ...
        <div className="chart" style={{ marginTop: 8 }}><LineChart points={bwPoints} h={130} unit={S.unit} goal={S.targetW} label={t('Body weight trend, last 30 days')} /></div>
