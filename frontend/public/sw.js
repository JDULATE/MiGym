/* MiGym service worker — runtime caching (works with Vite's hashed asset names).
   Media (img/gif) cache-first; everything else network-first with offline fallback.
   Forked from openGym's service worker (AGPL-3.0-or-later, © Duarte Santos). */
const CACHE = 'migym-rt-v1'
